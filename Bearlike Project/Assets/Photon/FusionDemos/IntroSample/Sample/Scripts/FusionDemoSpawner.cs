...
namespace FusionDemo {
  ...
  /// </summary>
  public class FusionDemoSpawner : NetworkBehaviour, IPlayerLeft {
    ...
    public override void Spawned() {
      ...
      var playerSettingsView = FindObjectOfType<PlayerSettingsView>(true);
      ...
      if (playerSettingsView) {
        RPC_RequestAvatarSpawn(playerSettingsView.GetSelectedSkin(), Runner.LocalPlayer, playerSettingsView.ConnectionArgs.Username);
      } else {
