...
namespace GamePlay.StageLevel
{
    public class StageLevelBase : NetworkBehaviour
    {
        ...
        [Header("몬스터 정보")] public List<NetworkSpawner> monsterSpawnerList = new List<NetworkSpawner>();
        ...
        private void Start()
        {
            ...
            if (monsterParentTransform == null)
            {
                monsterParentTransform = gameObject.transform;
            }
        }
