...
// 거리 감쇠 계산 함수
float CalCulateDistanceAttenuation(float distance, float constant, float _linear, float quadratic)
{
   return 1.0 / (constant + _linear * distance + quadratic * (distance * distance));
}
